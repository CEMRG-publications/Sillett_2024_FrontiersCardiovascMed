...
for Case in 12 15 16 #02 05 06 07 08 09 12 15 16 # Cases which have 10 time frames
do
	...
	do
		...
		do
			...
			~/Software/CemrgApp_v2.1/bin/MLib/transform-image ~/Data/MarinaData/CT_Charlie/CT-CRT-${Case}/dcm0/LA-Clip/PVeinsCroppedImage-RPI.nii\
