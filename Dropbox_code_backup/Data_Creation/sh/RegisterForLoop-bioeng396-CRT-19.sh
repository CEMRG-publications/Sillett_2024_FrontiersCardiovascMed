...
## Register ForLoop for Cases with 10 frames on bioeng396-pc

## NOTE: Case 19 needed its own script since it uses non-cropped images!

for Case in CT-CRT-19 # Cases which have 10 time frames
do
	...
	do
		...
		do
			...
			do
				cp /home/csi20/$Case/nifti/dcm-$img.nii $Path/SW-${i}-BE-${j}/
			done
