...
if __name__ == '__main__':
    ...
    parser.add_argument('--contourFile', help='basename for output contour files eg. 4ch_contour-{time}.vtk',\
                        default='4ch_contour-')    
    parser.add_argument('--png_out', help='output png filename', default='4chamber_long_strain.png')
    ...
    np.savetxt(f'{args.filepath}/4chamber_strain_transient.txt', contour_len, fmt="%g")
    np.savetxt(f'{args.filepath}/4chamber_reservoir_strain.txt', np.array([res_strain]), fmt="%g")
