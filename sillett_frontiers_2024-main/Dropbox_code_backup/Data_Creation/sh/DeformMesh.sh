...
do
	...
	GTPath=~/Dropbox/phd/Data/RG_CT_Cases/${Case}/dcm4/Manual
	dcm0Path=~/Dropbox/phd/Data/RG_CT_Cases/${Case}/dcm0/Hao-Network
	TrackingPath=~/Dropbox/phd/Data/RG_CT_Cases/${Case}/MT-HiRes-TDownsampled
	FibresPath=~/Dropbox/phd/Data/RG_CT_Cases/${Case}/dcm0/Fibres_HaoSeg

	casePath=~/Dropbox/phd/Data/RG_CT_Cases/${Case}
	...
	do
		...
		do
			...
			do
				...
				#  ${TrackingPath}/SW-${i}-BE-${j}/cLr-fibres-aligned-${k}.vtp -dofin ${TrackingPath}/SW-${i}-BE-${j}/SW-${i}-BE-${j}.dof\
				#   -ascii -St ${k}0 -verbose 3

				~/Software/CemrgApp_v2.1/bin/MLib/transform-points ${FibresPath}/clean-Labelled-refined-fibres-aligned.vtp\
				 ${TrackingPath}/SW-${i}-BE-${j}/veri/cLr-fibres-aligned-${k}.vtp -dofin ${TrackingPath}/SW-${i}-BE-${j}/veri/veri.dof\
				  -ascii -St ${k}0 -verbose 3
